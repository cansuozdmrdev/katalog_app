...
import 'package:katalog_app/components/product_card.dart';
import 'package:katalog_app/model/product_model.dart';
import 'package:katalog_app/services/api_service.dart';
import 'package:katalog_app/views/card_screen.dart';
import 'package:katalog_app/views/product_detail_screen.dart';
...
class HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> loadProducts() async {
    try {
      ...
      setState(() {
        errorMesage = "Failed to loud products.";
      });
    } finally {
      setState(() {
        isLoading = false;
